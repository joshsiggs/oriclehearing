...
const Privacy = () => {
    return (
        <>
            ...
            <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.oriclehearing.com (the “Site”).</p>
            ...
            <br />- “Log files” track actions occurring on the Site, and collect data including your IP address, browser type, Internet service provider, referring/exit pages, and date/time stamps.
                <br />- “Web beacons”, “tags”, and “pixels” are electronic files used to record information about how you browse the Site.</p>
            ...
            <br />- Bing: https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</p>
            ...
            <h4> Affiliation</h4>
        <p> This product is affiliated with the company:<br />
            Lifetime Well LLC<br />
            2159 India St<br />
            San Diego, CA 92101
        </p>
            ...
            <h4>Contact us</h4>
            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at <a href="mailto:support@oriclehearing.com">support@oriclehearing.com</a> or by mail using the details provided below:</p>

            <h4>Oricle Hering Aid</h4>
            <p>[Re: Privacy Compliance Officer]<br />
            Oricle Hering Aid, 30 N Gould St Sheridan, WY 82801 Ste 11834, United States</p>
        </>
    )
}
